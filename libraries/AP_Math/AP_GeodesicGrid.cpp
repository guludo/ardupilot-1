...
/* This was generated with
 * libraries/AP_Math/tools/geodesic_grid/geodesic_grid.py */
const Vector3f AP_GeodesicGrid::_normalized_centroids[80]{
    {-0.934172f,  0.000000f, -0.356822f},
    {-0.936339f,  0.309017f, -0.166667f},
    {-0.745356f,  0.000000f, -0.666667f},
    {-0.936339f, -0.309017f, -0.166667f},
    {-0.577350f, -0.577350f, -0.577350f},
    {-0.578689f, -0.269672f, -0.769672f},
    {-0.769672f, -0.578689f, -0.269672f},
    {-0.269672f, -0.769672f, -0.578689f},
    {-0.356822f, -0.934172f,  0.000000f},
    {-0.666667f, -0.745356f,  0.000000f},
    {-0.166667f, -0.936339f, -0.309017f},
    {-0.166667f, -0.936339f,  0.309017f},
    { 0.000000f, -0.356822f, -0.934172f},
    {-0.309017f, -0.166667f, -0.936339f},
    { 0.000000f, -0.666667f, -0.745356f},
    { 0.309017f, -0.166667f, -0.936339f},
    { 0.356822f, -0.934172f,  0.000000f},
    { 0.166667f, -0.936339f, -0.309017f},
    { 0.166667f, -0.936339f,  0.309017f},
                             ...
                             const bool inclusive)
{
    ...
    for (int i = 0; i < 80; i++) {
        auto w = _normalized_centroids[i] - normalized;
        float sq_dist = w.x * w.x + w.y * w.y + w.z * w.z;
        if (is_equal(min_sq_dist, sq_dist)) {
            has_equal = true;
