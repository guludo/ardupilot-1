...
bool AP_InertialSensor_LSM9DS0::_init_sensor()
{
    ...
    #error GPIO pin DRDY_GPIO_PIN_A must be defined
#endif
#ifndef DRDY_GPIO_PIN_G
    #error GPIO pin DRDY_GPIO_PIN_G must be defined
#endif
...
/* TODO: maybe we should make this function inline */
bool AP_InertialSensor_LSM9DS0::_accel_data_ready()
{
    /* TODO: Should we be using some sort of "LOW" constant here? */
...
bool AP_InertialSensor_LSM9DS0::update()
{
    ...
    //TODO: Are we supposed to do any rotation here?

    _publish_gyro(_gyro_instance, gyro);
    _publish_accel(_accel_instance, accel);

    /* TODO: uncomment this block later: commented for tests purposes only
